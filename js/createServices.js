...
if(email_id == 0){
    ...
    form3.addEventListener('submit', async (e) => {
        ...
        db.collection('skills').add({
            title: form3.welcomeMessage.value,
            image: imageUrl
        })
        form3.title.value = '';
        form3.image.value = '';
    ...
    form4.addEventListener('submit', async (e) => {
        ...
        db.collection('contact').add({
            welcomeMessage: form4.welcomeMessage.value,
            image: imageUrl,
            profession: form4.profession.value
        })
        form4.welcomeMessage.value = '';
        form4.image.value = '';
        form4.profession.value = '';    
